...
# Tidying the data
Comment: Absolutely beautiful job with the data cleaning!
...
#Comment: I love the removeNumbers function! I didn't know that existed!
...
#Beautiful use of colors in your visualizations! They're very cohesive and appealing
...
normal_fruit_veg_plot <- fruit_veg_df %>% 
  ...
  theme(legend.position = "none")+
  labs(
    title = "Price Differences for Fruit and Veggies by Form",
    x = "Retail Price",
    y = "Form of Product"
  )
...
# RQ3 analysis:  What is the different between retail price for fruits and vegatbles by form? 
```{r}
price_form_anova <- aov(retail_price ~ form + fruit_veg, data = fruit_veg_df)

summary(price_form_anova)

pairwise.t.test(fruit_veg_df$retail_price, fruit_veg_df$form,
                p.adjust.method = "bonferroni")
```